...
<body id="main" class="Mtype_layout">
...
<video class="d-block w-100" controls autoplay muted>
    <source src="logo/0823_2.mp4" type="video/mp4">
</video>
<script>
    document.getElementById('d-block w-100').play();
</script>
</div>
<div class="carousel-item">
<img src="../logo/main4.jpg" class="d-block w-100" alt="...">
</div>
<div class="carousel-item">
<img src="../logo/main1.jpg" class="d-block w-100" alt="...">
</div>
</div>
...
<div id="desc_footer">
<div style="display: inline-block;width: 700px;"><span class="desc font-bellefair">MÊRCI BIEN IS AN
ARTISAN CLOTHING BRAND BASED ON THE UNIQUE TASTES OF ITS FOUNDER.THE BRAND USES NATURAL FIBERS
TO CREATE COMFORTABLE CLOTHING FOR A WIDE VARIETY OF LIFESTYLES.MÊRCI BIEN VALUES THE WORK OF
INDEPENDENT EMERGING DESIGNERS WHO HELP TO OFFER HIGH QUALITY.HANDMADE GARMENTS FOR EVERY
CUSTOMER.</span>
</div>
<div style="float: right;">
<a href="/product/content.do">SHOP NOW</a>
</div>
<div id="main_4" class="displaynone">
<div id="a_WF_3_3" class="fade_section">
<div class="a_WF_3_3">
    <div fade_set_top="0" fade_set_speed="2" fade_set_delay="0"
        class="xans-element- xans-product xans-product-listmain-4 xans-product-listmain xans-product-4 image-Area fade-list"
        style="transition-property: opacity, top; transition-duration: 2s; transition-delay: 0s; top: 0px; opacity: 1;">
        <div
            class="a_WF_3_3-slide swiper swiper-container-initialized swiper-container-horizontal">
            <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
        </div>
    </div>
    <div
        class="xans-element- xans-product xans-product-listmain-4 xans-product-listmain xans-product-4 text-Area">
        <div class="cover fade-list" fade_set_top="15" fade_set_speed="3" fade_set_delay=".5"
            style="transition-property: opacity, top; transition-duration: 3s; transition-delay: 0.5s; top: 0px; opacity: 1;">
        </div>
    </div>
</div>
</div>
            ...
            <ul>
                <li class="group">
                    ...
                    <div class="sub-category">
                        <ul>
                            <li><a href="/product/content.do/cate_no=891">티셔츠</a></li>
                ...
                <li class="group">
                    ...
                    <div class="sub-category">
                        <ul>
                            <li><a href="/product/content.do/cate_no=911">긴바지</a></li>
                            <li><a href="/product/content.do/cate_no=912">반바지</a></li>
                            <li><a href="/product/content.do/cate_no=913">스커트</a></li>
                        </ul>
                    </div>
                </li>
                <li class="group"><a href="/product/content.do/cate_no=94"
                ...
                <li class="group"><a href="/product/content.do/cate_no=95"
                ...
                <li class="group"><a href="/product/content.do/cate_no=161"
    ...
    <li class="group image-box">
        <div class="image-list" id="image-list-top"
            ...
            <a href="/product/content.do/cate_no=89"><img
                    ...
                    alt="">
                <span class="title">상의</span><span>바로 가기</span></a>
        </div>
        <div class="image-list"
            ...
            <a href="/product/content.do?cate_no=91"><img
                    ...
                    alt="">
                <span class="title">바지</span><span>바로 가기</span></a>
        </div>
        <div class="image-list"
            ...
            <a href="/product/content.do?cate_no=94"><img
                    ...
                    alt="">
                <span class="title">드레스</span><span>바로가기</span></a>
        </div>
        <div class="image-list"
            data_check="가방/https://aviemuah2020.cafe24.com/CATEGORY%20BANNER/2023%20summer/bagggg.jpg">
            <a href="/product/content.do?cate_no=95">
                <img src="https://aviemuah2020.cafe24.com/CATEGORY%20BANNER/2023%20summer/bagggg.jpg"
        ...
        <div class="image-list"
            ...
            <a href="/product/content.do?cate_no=161"><img
                    ...
                    alt="">
                <span class="title">신발</span><span>바로 가기</span></a>
        </div>
        <div class="image-list"
            data_check="홈/https://aviemuah2020.cafe24.com/CATEGORY%20BANNER/2023%20summer/homee.jpg">
            <a href="/product/content.do?cate_no=160">
                <img src="https://aviemuah2020.cafe24.com/CATEGORY%20BANNER/2023%20summer/homee.jpg"
                    alt=""><span class="title">악세서리</span>
...
<li class="xans-element- xans-layout xans-layout-statelogoff group sub log "><a
    href="/myshop/order/list.html">로그인</a>
</li>
<li class="group sub"><a href="#;" id="s-btn" class="search-btn">검색</a></li>
<li class="group sub cart"><a href="/cart/cart.do">장바구니<span
        class="xans-element- xans-layout xans-layout-orderbasketcount count displaynone EC-Layout_Basket-count-display ">(
