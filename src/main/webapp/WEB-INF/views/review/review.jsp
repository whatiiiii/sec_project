...
<li class="mun-list clear-fix xans-record-">
    ...
    <div class="info">
        <div class="mun-name"> <a href="../../article/article.do/board_no=${board.seq}" style="color:#555555;"><strong>${board.subject}</strong></a> <span class="txtEm"></span>
</div>
...
<c:forEach items="${listResult.list.content}" var="board" varStatus="loop">
    <c:if test="${loop.index eq 0}">
        <c:set var="gcode" value="${board.goods.gcode}" />
    </c:if>
</c:forEach>
