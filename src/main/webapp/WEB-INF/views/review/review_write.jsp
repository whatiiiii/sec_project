...
function handleClick() {
    let putGcode = document.getElementById("putGcode").value;
    uploadFile();
    passFrom();
    setTimeout(function () {
         location.href = "/board/review.do/goods_name="+putGcode;
    }, 300);
}
function uploadFile() {
...
<li class="mun-list clear-fix">
      ...
      <input type="text" id="putGcode" readonly style="display: none;">
                           <div class="thumb">
        <a id="myLink" href=""><img id="dd" src="" onerror="this.src='//img.echosting.cafe24.com/thumb/75x75.gif'" alt=""></a>
        </div>
        <div class="info">
