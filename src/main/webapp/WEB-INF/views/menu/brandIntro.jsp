...
<div id="k_WF_5_1">
    <div class="k_WF_5_1">
        <div class="cover">
            <video class="d-block w-100 resized-video" controls autoplay muted>
                <source src="/logo/0823_2.mp4" type="video/mp4">
            </video>
            <script>
                document.querySelector('.resized-video').play();
            </script>
            <style>
                .resized-video {
                    max-width: 50%;
            ...
            <div class="info">
                <h3>ABOUT</h3>
                <p>
                    MÊRCI BIEN는 설립자의 취향을 기반으로 만들어진 브랜드입니다.<br>
                    우리는 자연스러움에 가치를 두고 각자의 다양한 삶을 보다 편안하게 할 옷을 소개하며, 독립적인 신흥 디자이너들과 함께 당신의 집에 가장 오래도록 남아 있을 양품을 제공합니다.<br><br>
                    MÊRCI BIEN is an artisan clothing brand based on the unique tastes of its founder.<br>
                    The brand uses natural fibers to create comfortable clothing for a wide variety of lifestyles.<br>
                    MÊRCI BIEN values the work of independent emerging designers who help to offer high quality,handmade garments for every customer.
                </p>
                <br><br><br><br><h3>CONTACT</h3>
                <p>
                    Tel / <span class="M_tel">010-5390-0372</span><br>
                    Email / <span class="M_email">dhkim310@naver.com</span><br><span class="M_Addr">08505 서울 금천구 가산디지털2로 101 B동 306호</span><br><br><span class="M_runtime_1">OPEN  |  MON – FRI (09:30 – 18:30)</span> / <span class="M_runtime_2">CLOSE  |  HOLIDAYS</span>
                </p>
            </div>
        </div>
    </div>
