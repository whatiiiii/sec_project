...
<div class="login">
    ...
    <fieldset>
<legend>회원로그인</legend>
        <label class="id ePlaceholder text-en" title="Id"><input id="member_id" name="member_id" fw-filter="isFill" fw-label="아이디" fw-msg="" class="inputTypeText" placeholder="Id" value="" type="text"></label>
        <label class="password ePlaceholder text-en" title="password"><input id="member_passwd" name="member_passwd" fw-filter="isFill&amp;isMin[4]&amp;isMax[16]" fw-label="패스워드" fw-msg="" autocomplete="off" value="" type="password" placeholder="password"></label>
        <p class="security">
                            <img src="//img.echosting.cafe24.com/design/skin/default/member/ico_access.gif" alt="보안접속"> 보안접속             </p>

        <a href="#none" class="mun-btn login-btn" onclick="MemberAction.login('member_form_7931326741'); return false;">LOGIN</a>

        <ul class="button">
<li class="text-en">forgot your &nbsp;<a href="/member/id/find_id.html">id?</a>
</li>
            <li class="text-en">or &nbsp;<a href="/member/passwd/find_passwd_info.html">password?</a>
</li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="pwd" placeholder="비밀번호를 입력해주세요" required>
                    <div class="invalid-feedback">
                      비밀번호를 입력해주세요.
                    </div>
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="pwd_check" placeholder="" required>
                    <div class="invalid-feedback">
                      비밀번호를 입력해주세요.
                    </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-sm"><input type="text" class="form-control" id="phoneNum1" placeholder="" value="" required></div>
                <div class="col-sm"><input type="text" class="form-control" id="phoneNum1" placeholder="" value="" required></div>
                <div class="col-sm"><input type="text" class="form-control" id="phoneNum1" placeholder="" value="" required></div>
              </div>
                  <hr class="mb-4">
