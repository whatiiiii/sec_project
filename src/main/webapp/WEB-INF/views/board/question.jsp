...
<div class="swiper header_notice_slide swiper-container-initialized swiper-container-vertical">
    <ul class="swiper-wrapper" style="transition-duration: 1000ms;"><li class="swiper-slide M_headerNotice_list1 on"><a href="https://www.aviemuah.com/article/notice/1/103152/" class="M_headerNotice_desc1" style="font-size: 12px; line-height: 1.6em; font-weight: 400;">신세계 센텀점 오픈 기념 24시간 세일 이벤트!<br>자세한 내용은 공지사항을 확인해주세요.</a></li>
